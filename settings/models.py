...
class PageSettings(models.Model):
    ...
    key_features = models.JSONField(
        default=list,
        help_text="List of key features with title, description, and image path"
    )
    
    # Additional Features Section
    additional_features = models.JSONField(
        default=list,
        help_text="List of additional features with title and description"
    )
    
    # Team Section
    team_members = models.JSONField(
        default=list,
        help_text="List of team members with name, role, bio, and image path"
    )
    
    # Timeline Section
    timeline_items = models.JSONField(
        default=list,
        help_text="List of timeline items with year and description"
    )
