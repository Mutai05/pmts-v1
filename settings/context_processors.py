        ...
        if not page_settings:
            page_settings = PageSettings(
                ...
                key_features=[
                    {
                        "title": "All Projects",
                        "description": "View all county projects with customizable filters for status, budget, and more.",
                        "image": "img/All-projects-with-filters.png"
                    },
                ],
                additional_features=[
                    {
                        "title": "Real-Time Updates",
                        "description": "Monitor project statuses, budgets, and timelines instantly."
                    },
                ],
                team_members=[
                    {
                        "name": "Jane Doe",
                        "role": "Project Lead",
                        "bio": "Oversees PMTS development and stakeholder coordination.",
                        "image": "img/team.png"
                    },
                ],
                timeline_items=[
                    {
                        "year": "2021",
                        "description": "PMTS concept born to address gaps in project monitoring."
                    },
                ],
                faqs=[
                    {
