...
KEY_FEATURES_SCHEMA = {
    ...
    'items': {
        ...
        'properties': {
            ...
            'image': {'type': 'string', 'title': 'Image Path (relative to static)'},
        },
...
class PageSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'key_features': CustomJSONFormWidget(schema=KEY_FEATURES_SCHEMA),
            'additional_features': CustomJSONFormWidget(schema=ADDITIONAL_FEATURES_SCHEMA),
            'team_members': CustomJSONFormWidget(schema=TEAM_SCHEMA),
            'timeline_items': CustomJSONFormWidget(schema=TIMELINE_SCHEMA),
    ...
    fieldsets = (
        ('About Page', {
            ...
            'description': 'Manage content for the About page, including introduction, mission, vision, core values, and objectives.'
                ...
                ('Key Features', {
            'fields': ('key_features',),
            'description': 'Manage the key features section on the about page.'
        }),
        ('Additional Features', {
            'fields': ('additional_features',),
            'description': 'Manage the additional features section on the about page.'
        }),
        ('Team Section', {
            'fields': ('team_members',),
            'description': 'Manage the team members section on the about page.'
        }),
        ('Timeline Section', {
            'fields': ('timeline_items',),
            'description': 'Manage the timeline/journey section on the about page.'
        }),
        ('FAQs Page', {
            'fields': ('faqs',),
